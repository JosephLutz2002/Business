...
public class customTable extends VBox {
    ...
    public static class Person {
        ...
        public Person(String name, String address, String severity) {
    ...
    public void setItems(String unit, String address, String severity) {
        Person person = new Person(unit,address,severity);
        items.add(person);
